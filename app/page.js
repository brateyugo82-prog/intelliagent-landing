...
export default function HomePage() {
  return (
    <main className="flex flex-col items-center justify-center bg-gray-900 text-white">
      ...
      {/* CTA */}
      <section className="py-12 bg-gray-800 w-full text-center">
      ...
      <section id="features" className="grid md:grid-cols-3 gap-8 py-24 max-w-6xl px-6">
        {steps.map((f, i) => (
          <Link
            key={i}
            href={`/agent/${f.slug}`}
            className="bg-gray-800 p-8 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition text-center block"
          >
      ...
      <section id="pipeline" className="bg-gray-900 py-28 text-center px-6 w-full">
        ...
        <p className="text-gray-300 mb-16 text-lg max-w-3xl mx-auto">
          Jeder Agent übernimmt eine Aufgabe – gemeinsam bilden sie eine vollautomatisierte Pipeline.
        </p>
      ...
      {/* Pricing */}
      <section id="pricing" className="py-28 w-full px-6 bg-gray-800">
        <h2 className="text-4xl font-bold text-center mb-12 text-white">
          Pakete & Preise
        </h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-gray-700 p-8 rounded-2xl text-white shadow-lg">
          ...
          <div className="bg-gray-700 p-8 rounded-2xl text-white shadow-lg">
            ...
            <p className="mb-6">Für große Teams & Unternehmen.</p>
